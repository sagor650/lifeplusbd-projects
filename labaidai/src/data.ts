...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    version: "v0.3",
    title: "Proactive employee release",
    kpi: "Scheduled brief delivers; risky action waits for approval",
    description: "Package schedules, briefings, meeting capture, owner memory and approvals into Aria's proactive employee workflow.",
    basis: "Management release train + implemented DigitalRM proactive and safety features",
    status: "Target",
    release: true,
  },
  {
    ...
    version: "v1.0",
    title: "Production pilot release",
    kpi: "Build, unit, UI + acceptance suites pass",
    description: "Release the universal personal digital employee pilot with tenant controls, audit, documents and the complete user interface.",
    basis: "Management release train + DigitalRM release-verification surfaces",
    status: "Target",
    release: true,
  },
  {
